...
export function analyzeArtTasteFixed(likedArtworks: Artwork[]): TasteAnalysis {
  ...
  // Define Tags
  const categories = {
    romantic: ["art-01", "art-02", "art-04", "art-15", "art-21", "art-22", "art-25"], // Impressionist/Emotional
    classical: ["art-05", "art-06", "art-07", "art-10", "art-11", "art-12", "art-20", "art-23", "art-24"], // Classical
    weird: ["art-03", "art-09", "art-14", "art-16", "art-17", "art-18"], // Modern/Abstract/Surreal
    lonely: ["art-09", "art-13", "art-19", "art-24"] // Lonely/Heavy
  };
